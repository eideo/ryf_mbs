...
//		String encode= "UTF-8";
	...
	public static String bocSign(){
		...
		LogUtil.printInfoLog("boc sign report:\n" + res);
...
//				response = method.getResponseBodyAsString();
				...
				LogUtil.printInfoLog(response);
			}
		} catch (Exception e) {
			LogUtil.printErrorLog("httpRequest", e);
			throw new B2EException("请求银行接口异常:" + e.getMessage());
	...
	public static String updatePosData(Map<String, String> p){
		...
		LogUtil.printInfoLog("updatePosData: affected rows: " + affectedRows);
		return "OK";
	}
	...
	public static String openAdmin(){
		...
		int affectedRows = new AdminZHDao().update(sql);
		LogUtil.printInfoLog("openAdmin: affected rows: " + affectedRows);
		return "OK";
	}
	...
	public static String updateDfQueryFlag(Map<String, String> p){
		...
		int affectedRows = new AdminZHDao().update(sql);
		LogUtil.printInfoLog("updateDfQueryFlag: affected rows: " + affectedRows);
		return "OK";
	}
	...
	public static String  getBocommResultForYQ(Map<String, String> p){
		...
		LogUtil.printInfoLog("getBocommResultForYQ: tseq:"+oid+"\n"+"res:"+res);
		StringBuffer html = new StringBuffer();
		html.append("<html>");
		html.append("<head></head>");
		html.append("<body>");
...
//	}
	...
	public static String testSjQueryState(Map<String, String> p) throws Exception{
		...
		LogUtil.printInfoLog("testSjQueryState requestXml:"+queryXml);
		String response2=testSJBSocket(queryXml,g);
		LogUtil.printInfoLog("testSjQueryState responseXml:"+response2);
		return response2;
	}
