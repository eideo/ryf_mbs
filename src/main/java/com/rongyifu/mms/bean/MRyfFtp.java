...
public class MRyfFtp {
	...
	public String getFtpPassphrase() {
		return ftpPassphrase;
	}
	public void setFtpPassphrase(String ftpPassphrase) {
		this.ftpPassphrase = ftpPassphrase;
	}
