...
%>
		...
		<script type='text/javascript' src='../../public/js/ryt.js?<%=rand%>'></script> 
  		<script type="text/javascript" src="../../public/js/account/account_queryAcoountCzjlDetail.js?<%=rand%>"></script>
    </head>
    <body>
     <div class="style">
        <form name="MERHLOG"  method="post" action="">
         <table width="100%"  align="left"  class="tableBorder">
            <tr><td class="title" colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;充值记录查询&nbsp;&nbsp;</td></tr>
            <tr>
             <td class="th1" bgcolor="#D9DFEE" align="right" width="10%">充值日期：</td>
            ...
            <td colspan="6" align="center" style="height: 30px">
                ...
                <input class="button" type="button" value = " 查 询 " onclick="queryPageCzjl(1);" />
                 &nbsp; &nbsp; 
       ...
       <table  class="tablelist tablelist2" id="merHlogTable">
           <thead>
           <tr>
             <th>商户订单号</th><th>充值日期</th>
             <th>充值金额(元)</th><th>系统手续费(元)</th>
