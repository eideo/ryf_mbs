       ...
       <td align="left">&nbsp;
        ...
        <tr >
            <td colspan="2" height="30px">
                ...
                <input type="hidden" id="operId" name="operId" value="${sessionScope.SESSION_LOGGED_ON_USER.operId }"/>
...
<table class="tablelist tablelist2"  >
    <thead><tr><th>选择</th><th>商户号</th><th>商户简称</th><th>结算批号</th><th>结算日期</th><th>支付金额(元)</th><th>支付笔数</th><th>退款金额(元)</th><th>退款笔数</th>
        <th>手工调增(元)</th><th>手工调减(元)</th><th>系统手续费(元)</th><th>退回商户手续费(元)</th><th>清算金额(元)</th></tr>
    </thead>
...
<table class="tablelist tablelist2"  >
    <thead><tr><th>商户号</th><th>商户简称</th><th>订单号</th><th>交易金额</th><th>系统手续费</th>
            <th>交易类型</th><th>系统日期</th><th>交易流水号</th><th>原订单号</th></tr>
    </thead>
