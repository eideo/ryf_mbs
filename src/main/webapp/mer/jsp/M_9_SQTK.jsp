...
<tbody>
                ...
                <table width="100%"  id="refundTable" style="display: none" class="tableBorder" >
                    ...
                    <tr>
                        ...
                        <td align="left">
                        <textarea  id="refundReason2" cols="30" rows="4" maxlength="100" onKeyDown="isMaxLen(this,'intro_info');" onBlur="isMaxLen(this,'intro_info');" onKeyUp="isMaxLen(this,'intro_info');"></textarea>
