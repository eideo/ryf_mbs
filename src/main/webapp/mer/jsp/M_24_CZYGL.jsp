...
%>
        ...
        function init(){
        	...
        	document.getElementById("Aoper_name").value="";
        	document.getElementById("Aoper_pass").value="";
        	document.getElementById("Aoper_id").value="";
        	document.getElementById("Av_oper_pass").value="";
            var mid = $("mid").value;
            if(!mid || mid == '' ) return;
        ...
        var stateMap={0:"正常",1:"关闭"};
        function edit(i){
           // $("edit_table_id").style.display = "";
            var obj = m_opers[i];
            alert(obj.state +"状态" + "-===--"+stateMap[obj.state]);
            dwr.util.setValues({
            	v_operId:obj.operId,v_operName:obj.operName,
                v_operTel:obj.operTel,v_operEmail:obj.operEmail,
                // v_state:obj.state
            });
             jQuery('#v_state option[value = "'+obj.state+'"]').attr("selected","selected");
           // jQuery('#v_state option[value = "'+obj.state+'"]').attr("selected",true);
