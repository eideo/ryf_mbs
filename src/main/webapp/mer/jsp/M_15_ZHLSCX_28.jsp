...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class="style">
        ...
        <!--  账户流水查询(2.8新) -->
            <tr><td class="title" colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;商户流水查询&nbsp;&nbsp;</td>
            </tr>
            <tr>
            ...
            <td colspan="4" align="center" style="height: 30px">
              ...
              账户流水查询(2.8以前)</a>中 进行查询 -->
                ...
                <input class="button" type="button" value= " 下载XLS " onclick = "downloadLS(${sessionScope.SESSION_LOGGED_ON_USER.operId});"/>
            </td>
            </tr>
        </table>
       </form>
		       ...
		       <table  class="tablelist tablelist2" id="LSTable" style="display: none;">
		           <tr>
		             <th>商户号</th><th>系统日期</th><th>系统时间</th>
		            <th>收支标识</th><th>交易金额</th><th>交易手续费</th> <th>变动金额</th>
		             <!-- <th>可用余额</th> -->
		             <th>余额</th>
		              <th>电银流水号</th>
		             <th>简短说明</th>
