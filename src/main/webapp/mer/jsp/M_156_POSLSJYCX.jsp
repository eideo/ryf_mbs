...
%>
    ...
    <div class="style">
            ...
            <tr>
            	...
            	<td class="th1" align="right" >系统日期：</td>
           		<td align="left" width="30%">
               			<input id="beginDate" name="beginDate"  value=""  class="Wdate" type="text" onfocus="ryt_before_date('beginDate','endDate',0,'15',0)"/>&nbsp;至
       ...
       <table  class="tablelist tablelist2"  id="merTodayTable" style="display:none;">
        ...
        <!-- 详情页面 -->
        <table class="tableBorder detailBox"  id="detailHlogInfo" style="display: none;">
