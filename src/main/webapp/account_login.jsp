<%@page import="org.apache.xmlbeans.impl.xb.xmlconfig.Extensionconfig.Interface"%>
...
<script type="text/javascript">
    ...
    function submitForm(){
        ...
        LoginService.accountUserLogin(mid,uid, pwdResult, role, ckpwd);
    }
    //给登陆按钮绑定回车
                ...
                <ul class="denglu_list" >
                   ...
                   <li>
				   	<table>
				   		<tr>
				   			<!-- <td style="width: 90px;">
				   				<a href="account_login.jsp"><font style="color: red;">账户登录</font></a>
				   			</td>
